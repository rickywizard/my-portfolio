  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl flex items-center flex-col sm:flex-row gap-16 animate-float z-10 scale-75 lg:scale-80 2xl:scale-100">
        <div className="flex flex-col justify-center items-center sm:text-start text-center">
          <MagicReveal>
            <h1 className="text-4xl md:text-6xl font-magic mb-8 glow-text relative z-10">
              Welcome to My Magic Realm
            </h1>
          </MagicReveal>

          <MagicReveal delay={0.4}>
            <p className="text-2xl md:text-3xl text-purple-200 glow-text mb-8 z-10 relative">
